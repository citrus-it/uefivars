...
lazy_static! {
    static ref KNOWN_GUIDS: HashMap<&'static str, &'static str> = {
        ...
        // Ones I've seen in use with bhyve guests
        m.insert("8be4df61-93ca-11d2-aa0d-00e098032b8c",
            "GLOBAL_VARIABLE");
        m.insert("04b37fe8-f6ae-480b-bdd5-37d98c5e89aa",
            "EDKII_VAR_ERROR_FLAG");
        m.insert("59324945-ec44-4c0d-b1cd-9db139df070c",
            "EFI_ISCSI_INITIATOR_NAME_PROTOCOL_GUID");
        m.insert("5b446ed1-e30b-4faa-871a-3654eca36080",
            "EFI_IP4_CONFIG2_PROTOCOL_GUID");
        m.insert("4c19049f-4137-4dd3-9c10-8b97a83ffdfa",
            "EFI_MEMORY_TYPE_INFORMATION_GUID");
        m.insert("fab7e9e1-39dd-4f2b-8408-e20e906cb6de",
            "HD_BOOT_DEVICE_PATH_VARIABLE");
        m.insert("eb704011-1402-11d3-8e77-00a0c969723b",
            "MTC_VENDOR");
        m.insert("4b47d616-a8d6-4552-9d44-ccad2e0f4cf9",
            "ISCSI_CONFIG");
        m.insert("77fa9abd-0359-4d32-bd60-28f4e78f784b",
            "SecureBootPlatformID");
        m.insert("eaec226f-c9a3-477a-a826-ddc716cdc0e3",
            "WindowsID");

        // Others
        m.insert("00720665-67eb-4a99-baf7-d3c33a1c7cc9",
            "EFI_TCP4_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("02e800be-8f01-4aa6-946b-d71388e1833f",
            "EFI_MTFTP4_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("0379be4e-d706-437d-b037-edb82fb772a4",
            "EFI_DEVICE_PATH_UTILITIES_PROTOCOL_GUID");
        m.insert("03c4e603-ac28-11d3-9a2d-0090273fc14d",
            "EFI_PXE_BASE_CODE_PROTOCOL_GUID");
        m.insert("05ad34ba-6f02-4214-952e-4da0398e2bb9",
            "EFI_DXE_SERVICES_TABLE_GUID");
        m.insert("09576e91-6d3f-11d2-8e39-00a0c969723b",
            "EFI_DEVICE_PATH_PROTOCOL_GUID");
        m.insert("09576e92-6d3f-11d2-8e39-00a0c969723b",
            "EFI_FILE_INFO_ID");
        m.insert("09576e93-6d3f-11d2-8e39-00a0c969723b",
            "EFI_FILE_SYSTEM_INFO_ID");
        m.insert("0db48a36-4e54-ea9c-9b09-1ea5be3a660b",
            "EFI_REST_PROTOCOL_GUID");
        m.insert("0faaecb1-226e-4782-aace-7db9bcbf4daf",
            "EFI_FTP4_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("107a772c-d5e1-11d4-9a46-0090273fc14d",
            "EFI_COMPONENT_NAME_PROTOCOL_GUID");
        m.insert("11b34006-d85b-4d0a-a290-d5a571310ef7",
            "PCD_PROTOCOL_GUID");
        m.insert("13a3f0f6-264a-3ef0-f2e0-dec512342f34",
            "EFI_PCD_PROTOCOL_GUID");
        m.insert("13ac6dd1-73d0-11d4-b06b-00aa00bd6de7",
            "EFI_EBC_INTERPRETER_PROTOCOL_GUID");
        m.insert("143b7632-b81b-4cb7-abd3-b625a5b9bffe",
            "EFI_EXT_SCSI_PASS_THRU_PROTOCOL_GUID");
        m.insert("151c8eae-7f2c-472c-9e54-9828194f6a88",
            "EFI_DISK_IO2_PROTOCOL_GUID");
        m.insert("1682fe44-bd7a-4407-b7c7-dca37ca3922d",
            "EFI_TLS_CONFIGURATION_PROTOCOL_GUID");
        m.insert("18a031ab-b443-4d1a-a5c0-0c09261e9f71",
            "EFI_DRIVER_BINDING_PROTOCOL_GUID");
        m.insert("1c0c34f6-d380-41fa-a049-8ad06c1a66aa",
            "EFI_EDID_DISCOVERED_PROTOCOL_GUID");
        m.insert("1d3de7f0-0807-424f-aa69-11a54e19a46f",
            "EFI_ATA_PASS_THRU_PROTOCOL_GUID");
        m.insert("2755590c-6f3c-42fa-9ea4-a3ba543cda25",
            "EFI_DEBUG_SUPPORT_PROTOCOL_GUID");
        m.insert("2a534210-9280-41d8-ae79-cada01a2b127",
            "EFI_DRIVER_HEALTH_PROTOCOL_GUID");
        m.insert("2c8759d5-5c2d-66ef-925f-b66c101957e2",
            "EFI_IP6_PROTOCOL_GUID");
        m.insert("2f707ebb-4a1a-11d4-9a38-0090273fc14d",
            "EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL_GUID");
        m.insert("31878c87-0b75-11d5-9a4f-0090273fc14d",
            "EFI_SIMPLE_POINTER_PROTOCOL_GUID");
        m.insert("31a6406a-6bdf-4e46-b2a2-ebaa89c40920",
            "EFI_HII_IMAGE_PROTOCOL_GUID");
        m.insert("330d4706-f2a0-4e4f-a369-b66fa8d54385",
            "EFI_HII_CONFIG_ACCESS_PROTOCOL_GUID");
        m.insert("387477c1-69c7-11d2-8e39-00a0c969723b",
            "EFI_SIMPLE_TEXT_INPUT_PROTOCOL_GUID");
        m.insert("387477c2-69c7-11d2-8e39-00a0c969723b",
            "EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL_GUID");
        m.insert("39b68c46-f7fb-441b-b6ec-16b0f69821f3",
            "EFI_CAPSULE_REPORT_GUID");
        m.insert("3ad9df29-4501-478d-b1f8-7f7fe70e50f3",
            "EFI_UDP4_PROTOCOL_GUID");
        m.insert("3b95aa31-3793-434b-8667-c8070892e05e",
            "EFI_IP4_CONFIG_PROTOCOL_GUID");
        m.insert("3e35c163-4074-45dd-431e-23989dd86b32",
            "EFI_HTTP_UTILITIES_PROTOCOL_GUID");
        m.insert("3e745226-9818-45b6-a2ac-d7cd0e8ba2bc",
            "EFI_USB2_HC_PROTOCOL_GUID");
        m.insert("41d94cd2-35b6-455a-8258-d4e51334aadd",
            "EFI_IP4_PROTOCOL_GUID");
        m.insert("49152e77-1ada-4764-b7a2-7afefed95e8b",
            "EFI_DEBUG_IMAGE_INFO_TABLE_GUID");
        m.insert("4cf5b200-68b8-4ca5-9eec-b23e3f50029a",
            "EFI_PCI_IO_PROTOCOL_GUID");
        m.insert("4d330321-025f-4aac-90d8-5ed900173b63",
            "EFI_DRIVER_DIAGNOSTICS_PROTOCOL_GUID");
        m.insert("4f948815-b4b9-43cb-8a33-90e060b34955",
            "EFI_UDP6_PROTOCOL_GUID");
        m.insert("587e72d7-cc50-4f79-8209-ca291fc1a10f",
            "EFI_HII_CONFIG_ROUTING_PROTOCOL_GUID");
        m.insert("5b1b31a1-9562-11d2-8e3f-00a0c969723b",
            "EFI_LOADED_IMAGE_PROTOCOL_GUID");
        m.insert("5c198761-16a8-4e69-972c-89d67954f81d",
            "EFI_DRIVER_SUPPORTED_EFI_VERSION_PROTOCOL_GUID");
        m.insert("65530bc7-a359-410f-b010-5aadc7ec2b62",
            "EFI_TCP4_PROTOCOL_GUID");
        m.insert("66ed4721-3c98-4d3e-81e3-d03dd39a7254",
            "EFI_UDP6_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("6a1ee763-d47a-43b4-aabe-ef1de2ab56fc",
            "EFI_HII_PACKAGE_LIST_PROTOCOL_GUID");
        m.insert("6a7a5cff-e8d9-4f70-bada-75ab3025ce14",
            "EFI_COMPONENT_NAME2_PROTOCOL_GUID");
        m.insert("6b30c738-a391-11d4-9a3b-0090273fc14d",
            "EFI_PLATFORM_DRIVER_OVERRIDE_PROTOCOL_GUID");
        m.insert("7739f24c-93d7-11d4-9a3a-0090273fc14d",
            "EFI_HOB_LIST_GUID");
        m.insert("78247c57-63db-4708-99c2-a8b4a9a61f6b",
            "EFI_MTFTP4_PROTOCOL_GUID");
        m.insert("783658a3-4172-4421-a299-e009079c0cb4",
            "EFI_LEGACY_BIOS_PLATFORM_PROTOCOL_GUID");
        m.insert("7a59b29b-910b-4171-8242-a85a0df25b5b",
            "EFI_HTTP_PROTOCOL_GUID");
        m.insert("7ab33a91-ace5-4326-b572-e7ee33d39f16",
            "EFI_MANAGED_NETWORK_PROTOCOL_GUID");
        m.insert("7f1647c8-b76e-44b2-a565-f70ff19cd19e",
            "EFI_DNS6_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("83f01464-99bd-45e5-b383-af6305d8e9e6",
            "EFI_UDP4_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("87c8bad7-0595-4053-8297-dede395f5d5b",
            "EFI_DHCP6_PROTOCOL_GUID");
        m.insert("8868e871-e4f1-11d3-bc22-0080c73c8881",
            "EFI_ACPI_TABLE_GUID");
        m.insert("8a219718-4ef5-4761-91c8-c0f04bda9e56",
            "EFI_DHCP4_PROTOCOL_GUID");
        m.insert("8b843e20-8132-4852-90cc-551a4e4a7f1c",
            "EFI_DEVICE_PATH_TO_TEXT_PROTOCOL_GUID");
        m.insert("8d59d32b-c655-4ae9-9b15-f25904992a43",
            "EFI_ABSOLUTE_POINTER_PROTOCOL_GUID");
        m.insert("9042a9de-23dc-4a38-96fb-7aded080516a",
            "EFI_GRAPHICS_OUTPUT_PROTOCOL_GUID");
        m.insert("937fe521-95ae-4d1a-8929-48bcd90ad31a",
            "EFI_IP6_CONFIG_PROTOCOL_GUID");
        m.insert("952cb795-ff36-48cf-a249-4df486d6ab8d",
            "EFI_TLS_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("964e5b21-6459-11d2-8e39-00a0c969723b",
            "EFI_BLOCK_IO_PROTOCOL_GUID");
        m.insert("964e5b22-6459-11d2-8e39-00a0c969723b",
            "EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_GUID");
        m.insert("9d9a39d8-bd42-4a73-a4d5-8ee94be11380",
            "EFI_DHCP4_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("9e23d768-d2f3-4366-9fc3-3a7aba864374",
            "EFI_VLAN_CONFIG_PROTOCOL_GUID");
        m.insert("9fb9a8a1-2f4a-43a6-889c-d0f7b6c47ad5",
            "EFI_DHCP6_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("a3979e64-ace8-4ddc-bc07-4d66b8fd0977",
            "EFI_IPSEC2_PROTOCOL_GUID");
        m.insert("a4c751fc-23ae-4c3e-92e9-4964cf63f349",
            "EFI_UNICODE_COLLATION_PROTOCOL2_GUID");
        m.insert("a77b2472-e282-4e9f-a245-c2c0e27bbcc1",
            "EFI_BLOCK_IO2_PROTOCOL_GUID");
        m.insert("ae3d28cc-e05b-4fa1-a011-7eb55a3f1401",
            "EFI_DNS4_PROTOCOL_GUID");
        m.insert("b625b186-e063-44f7-8905-6a74dc6f52b4",
            "EFI_DNS4_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("b9d4c360-bcfb-4f9b-9298-53c136982258",
            "EFI_FORM_BROWSER2_PROTOCOL_GUID");
        m.insert("bb25cf6f-f1d4-11d2-9a0c-0090273fc1fd",
            "EFI_SERIAL_IO_PROTOCOL_GUID");
        m.insert("bc62157e-3e33-4fec-9920-2d3b36d750df",
            "EFI_LOADED_IMAGE_DEVICE_PATH_PROTOCOL_GUID");
        m.insert("bd8c1056-9f36-44ec-92a8-a6337f817986",
            "EFI_EDID_ACTIVE_PROTOCOL_GUID");
        m.insert("bdc8e6af-d9bc-4379-a72a-e0c4e75dae1c",
            "EFI_HTTP_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("bf0a78ba-ec29-49cf-a1c9-7ae54eab6a51",
            "EFI_MTFTP6_PROTOCOL_GUID");
        m.insert("c51711e7-b4bf-404a-bfb8-0a048ef1ffe4",
            "EFI_IP4_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("c68ed8e2-9dc6-4cbd-9d94-db65acc5c332",
            "EFI_SMM_COMMUNICATION_PROTOCOL_GUID");
        m.insert("ca37bc1f-a327-4ae9-828a-8c40d8506a17",
            "EFI_DNS6_PROTOCOL_GUID");
        m.insert("ce345171-ba0b-11d2-8e4f-00a0c969723b",
            "EFI_DISK_IO_PROTOCOL_GUID");
        m.insert("ce5e5929-c7a3-4602-ad9e-c9daf94ebfcf",
            "EFI_IPSEC_CONFIG_PROTOCOL_GUID");
        m.insert("d42ae6bd-1352-4bfb-909a-ca72a6eae889",
            "LZMAF86_CUSTOM_DECOMPRESS_GUID");
        m.insert("d8117cfe-94a6-11d4-9a3a-0090273fc14d",
            "EFI_DECOMPRESS_PROTOCOL_GUID");
        m.insert("d9760ff3-3cca-4267-80f9-7527fafa4223",
            "EFI_MTFTP6_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("db47d7d3-fe81-11d3-9a35-0090273fc14d",
            "EFI_FILE_SYSTEM_VOLUME_LABEL_ID");
        m.insert("dd9e7534-7762-4698-8c14-f58517a625aa",
            "EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL_GUID");
        m.insert("dfb386f7-e100-43ad-9c9a-ed90d08a5e12",
            "EFI_IPSEC_PROTOCOL_GUID");
        m.insert("e9ca4775-8657-47fc-97e7-7ed65a084324",
            "EFI_HII_FONT_PROTOCOL_GUID");
        m.insert("eb338826-681b-4295-b356-2b364c757b09",
            "EFI_FTP4_PROTOCOL_GUID");
        m.insert("eb9d2d2f-2d88-11d3-9a16-0090273fc14d",
            "MPS_TABLE_GUID");
        m.insert("eb9d2d30-2d88-11d3-9a16-0090273fc14d",
            "ACPI_TABLE_GUID");
        m.insert("eb9d2d31-2d88-11d3-9a16-0090273fc14d",
            "SMBIOS_TABLE_GUID");
        m.insert("eb9d2d32-2d88-11d3-9a16-0090273fc14d",
            "SAL_SYSTEM_TABLE_GUID");
        m.insert("eba4e8d2-3858-41ec-a281-2647ba9660d0",
            "EFI_DEBUGPORT_PROTOCOL_GUID");
        m.insert("ec20eb79-6c1a-4664-9a0d-d2e4cc16d664",
            "EFI_TCP6_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("ec835dd3-fe0f-617b-a621-b350c3e13388",
            "EFI_IP6_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("ee4e5898-3914-4259-9d6e-dc7bd79403cf",
            "LZMA_CUSTOM_DECOMPRESS_GUID");
        m.insert("ef9fc172-a1b2-4693-b327-6d32fc416042",
            "EFI_HII_DATABASE_PROTOCOL_GUID");
        m.insert("f2fd1544-9794-4a2c-992e-e5bbcf20e394",
            "SMBIOS3_TABLE_GUID");
        m.insert("f36ff770-a7e1-42cf-9ed2-56f0f271f44c",
            "EFI_MANAGED_NETWORK_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("f44c00ee-1f2c-4a00-aa09-1c9f3e0800a3",
            "EFI_ARP_SERVICE_BINDING_PROTOCOL_GUID");
        m.insert("f4b427bb-ba21-4f16-bc4e-43e416ab619c",
            "EFI_ARP_PROTOCOL_GUID");
        m.insert("f4ccbfb7-f6e0-47fd-9dd4-10a8f150c191",
            "EFI_SMM_BASE2_PROTOCOL_GUID");
        m.insert("f541796d-a62e-4954-a775-9584f61b9cdd",
            "EFI_TCG_PROTOCOL_GUID");
        m.insert("fc1bcdb0-7d31-49aa-936a-a4600d9dd083",
            "EFI_CRC32_GUIDED_SECTION_EXTRACTION_GUID");
        m.insert("ffe06bdd-6107-46a6-7bb2-5a9c7ec5275c",
